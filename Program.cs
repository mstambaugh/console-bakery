...
namespace Order 
{
  public class Program
  {
    ...
    {
      Bread breadsorder = new Bread(0, 0);
      
      Pastries pastriesorder = new Pastries(0, 0);
      ...
      while (!OrderComplete)
      {
        ...
        else if (input.ToUpper() == "ORDER")
        {
          ...
          Console.WriteLine("Your total will be € " + (breadsorder.BreadPrice + pastriesorder.PastryPrice));
